...
if(isset($_GET['message'])){
    ...
    if($obj->Normal_Query("SELECT clean_message_id FROM clean WHERE clean_user_id = ?",[$user_id])){
        ...
        $obj->Normal_Query("SELECT * FROM messages INNER JOIN users ON messages.user_id = users.id WHERE messages.msg_id BETWEEN $last_msg_id AND $msg_table_id AND messages.msg_area ='room' ORDER BY messages.msg_id ASC");
            ...
            foreach($messages_row as $informations):
                ...
                if($db_user_id == $user_id){
                  ...
                  echo '<div class="left-message">
                        ...
                        echo '<div class="left-message">
                        <div class="sender-img-block">
                           <img src="assets/img/user.png" class="sender-img" >
                        '.$user_online_status.'                            
                        </div> <!--close of sender-img-block -->
                        <div class="left-msg-area common-margin">
                            <div class="user-name-date">
