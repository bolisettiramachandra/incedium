<style>
    ...
    <th>Grades</th>
    <tr>
    <td>PROCESSORS AND CONTROLLERS</td>
    ...
    incr[0] = 4; // PROCESSORS AND CONTROLLERS
    incr[1] = 4; // CT 3
    incr[2] = 3; // ELECTIVE - 1 
    incr[3] = 4; // ELECTIVE - 2
    incr[4] = 2; // ELECTIVE - 3    
    ...
    for (var x = 0; x < 8; x++)
            ...
            if (validgrcheck == 0)
                    {
                       if(x == 0)
                        {
                    alert("Error- Could not recognize the grade entered for Processors and Controllers. Please use standard college grades in the form of O X A B C D F DT AB.");
                    return 0;
                        }
     if(x == 1)
                        {
                    alert("Error- Could not recognize the grade entered for CT - 3. Please use standard college grades in the form of O X A B C D F DT AB.");
                    return 0;
    }
     if(x == 2)
                        {
     ...
     if(x == 4)
                        {
                    alert("Error- Could not recognize the grade entered for ELECTIVE -3. Please use standard college grades in the form of O X A B C D F DT AB.");
                    return 0;
    }
     if(x == 5)
                        {
